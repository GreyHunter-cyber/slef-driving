...
(cl:defmethod cl:initialize-instance :after ((m <PointXYA>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'PointXYA)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name cloud_msgs-msg:<PointXYA> is deprecated: use cloud_msgs-msg:PointXYA instead.")))

(cl:ensure-generic-function 'x-val :lambda-list '(m))
(cl:defmethod x-val ((m <PointXYA>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:x-val is deprecated.  Use cloud_msgs-msg:x instead.")
  (x m))

(cl:ensure-generic-function 'y-val :lambda-list '(m))
(cl:defmethod y-val ((m <PointXYA>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:y-val is deprecated.  Use cloud_msgs-msg:y instead.")
  (y m))

(cl:ensure-generic-function 'yaw-val :lambda-list '(m))
(cl:defmethod yaw-val ((m <PointXYA>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader cloud_msgs-msg:yaw-val is deprecated.  Use cloud_msgs-msg:yaw instead.")
  (yaw m))
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<PointXYA>)))
  ...
  (cl:format cl:nil "float64 x~%float64 y~%float64 yaw  # degs~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'PointXYA)))
  "Returns full string definition for message of type 'PointXYA"
  (cl:format cl:nil "float64 x~%float64 y~%float64 yaw  # degs~%~%~%"))
