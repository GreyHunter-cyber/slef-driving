...
if(lego_loc_CONFIG_INCLUDED)
  return()
endif()
set(lego_loc_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(lego_loc_SOURCE_PREFIX /home/nvidia/iau_ros_legoloam/src/iau_location)
  set(lego_loc_DEVEL_PREFIX /home/nvidia/iau_ros_legoloam/devel)
  set(lego_loc_INSTALL_PREFIX "")
  set(lego_loc_PREFIX ${lego_loc_DEVEL_PREFIX})
else()
  set(lego_loc_SOURCE_PREFIX "")
  set(lego_loc_DEVEL_PREFIX "")
  set(lego_loc_INSTALL_PREFIX /home/nvidia/iau_ros_legoloam/install)
  set(lego_loc_PREFIX ${lego_loc_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'lego_loc' is deprecated")
...
if(NOT "/home/nvidia/iau_ros_legoloam/src/iau_location/include;/usr/include/pcl-1.8;/usr/include/eigen3;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/aarch64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/aarch64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/aarch64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${lego_loc_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'lego_loc' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'lego_loc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/iau_ros_legoloam/src/iau_location/${idir}'.  ${_report}")
    endif()
    _list_append_unique(lego_loc_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND lego_loc_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND lego_loc_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT lego_loc_NUM_DUMMY_TARGETS)
      set(lego_loc_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::lego_loc::wrapped-linker-option${lego_loc_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR lego_loc_NUM_DUMMY_TARGETS "${lego_loc_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::lego_loc::wrapped-linker-option${lego_loc_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND lego_loc_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(lego_loc_LIBRARY_DIRS ${lib_path})
      list(APPEND lego_loc_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'lego_loc'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND lego_loc_LIBRARIES ${lib})
    endif()
  endif()
...
set(lego_loc_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${lego_loc_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 lego_loc_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${lego_loc_dep}_FOUND)
      find_package(${lego_loc_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${lego_loc_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(lego_loc_INCLUDE_DIRS ${${lego_loc_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(lego_loc_LIBRARIES ${lego_loc_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${lego_loc_dep}_LIBRARIES})
  _list_append_deduplicate(lego_loc_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(lego_loc_LIBRARIES ${lego_loc_LIBRARIES})

  _list_append_unique(lego_loc_LIBRARY_DIRS ${${lego_loc_dep}_LIBRARY_DIRS})
  list(APPEND lego_loc_EXPORTED_TARGETS ${${lego_loc_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${lego_loc_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
